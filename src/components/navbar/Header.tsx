...
import navOpen from "../../assets/icons/open.png";
import navClose from "../../assets/icons/close.png";
      ...
      <div className="container wf-100">
        <nav className="nav flex alignCenter justifyBetween">
          <a
            href="#"
            className={
              openNav ? "logo flex alignCenter fixed" : "logo flex alignCenter"
            }
          >
          ...
          <ul
            className={
              openNav ? "flex alignCenter activeNav" : "flex alignCenter"
            }
          >
          ...
          <div
            className={
              openNav
                ? "langAnd_navBtn flex alignCenter justifyBetween fixed"
                : "langAnd_navBtn flex alignCenter justifyBetween"
            }
          >
            <div
              className={
            ...
            <div
              className="columnNavbar_btn hidden"
              onClick={() => {
                setOpenNav(!openNav);
              }}
            >
              <img
                src={openNav ? navClose : navOpen}
                alt="Column Menu Button"
              />
            </div>
          </div>
        </nav>
